...
/* harmony import */ var _modules_sliders_mainSlider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/sliders/mainSlider */ "./src/js/modules/sliders/mainSlider.js");
/* harmony import */ var _modules_sliders_miniSlider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/sliders/miniSlider */ "./src/js/modules/sliders/miniSlider.js");
/* harmony import */ var _modules_videoPopup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/videoPopup */ "./src/js/modules/videoPopup.js");
...
window.addEventListener("DOMContentLoaded", function () {
  var slider = new _modules_sliders_mainSlider__WEBPACK_IMPORTED_MODULE_2__["default"]({
    triggersSelector: ".page .next",
    wrapperSelector: ".page"
  });
  slider.render(); //second page

  var secondPageBigSlider = new _modules_sliders_mainSlider__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  var showUpSlider = new _modules_sliders_miniSlider__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_sliders_miniSlider__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_sliders_miniSlider__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  feedSlider.init();
  new _modules_videoPopup__WEBPACK_IMPORTED_MODULE_4__["default"](".showup .play", ".overlay").init();
  new _modules_videoPopup__WEBPACK_IMPORTED_MODULE_4__["default"](".module__video-item .play", ".overlay").init(); // second page videoPopup

  new _modules_cards__WEBPACK_IMPORTED_MODULE_5__["default"](".officerold", ".officer__card-item", ".plus").init();
  new _modules_cards__WEBPACK_IMPORTED_MODULE_5__["default"](".officernew", ".officer__card-item", ".plus").init(); // new Accordion('.accordion-container');

  var mainFromJoin = new _modules_form__WEBPACK_IMPORTED_MODULE_6__["default"]();
  mainFromJoin.init();
  var w = 8;
  var h = 11;

  function matrix(h, w) {
    var result = new Array(h).fill().map(function (ar) {
...
function () {
  ...
  _createClass(Forms, [{
    key: "clearAllInputs",
    value: function clearAllInputs(inputs) {
      ...
      return regeneratorRuntime.async(function sendRequest$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              this.fetchRequest = _context.sent;
              _context.next = 5;
              return regeneratorRuntime.awrap(this.fetchRequest.text());
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener("submit", function (e) {
          e.preventDefault();
          _this.messageBlock = document.createElement("div");

          _this.messageBlock.classList.add("status");

          form.parentNode.appendChild(_this.messageBlock);
          _this.messageBlock.innerHTML = _this.messagesToShow.loading;
          _this.formData = new FormData(form);
          console.log(_this.formData);

          _this.sendRequest("assets/question.php", _this.formData).then(function (request) {
            _this.messageBlock.innerHTML = _this.messagesToShow.sucsess;
            console.log(request);
          }).catch(function (error) {
            _this.messageBlock.innerHTML = _this.messagesToShow.fail;
            console.throw(error);
          }).finally(function () {
            _this.clearAllInputs(_this.inputs);
...
function (_Slider) {
  ...
  function MainSlider(triggersSelector, wrapperSelector, prevOther, nextOther) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, triggersSelector, wrapperSelector, prevOther, nextOther));
  }
  ...
  _createClass(MainSlider, [{
      ...
      try {
        ...
        if (this.slides[this.sliderIndex - 1].classList.contains("modules")) {
          setTimeout(function () {
            ...
            _this.teacher.classList.add("fadeInUp");
          }, 3000);
        } else {
          this.teacher.style.opacity = "0";
    ...
    value: function render() {
      ...
      if (this.wrapper) {
        ...
        this.logo.forEach(function (el) {
          el.addEventListener("click", function (e) {
            e.preventDefault(); // console.log('ss');

            _this2.sliderIndex = 1;

            _this2.showSlide(_this2.sliderIndex);
          });
        });
        this.prevOther.forEach(function (btn) {
          btn.addEventListener('click', function () {
            _this2.plusIndex(-1);
          });
        });
        this.nextOther.forEach(function (btn) {
          btn.addEventListener('click', function () {
            _this2.plusIndex(1);
          });
        });
...
function (_Slider) {
  ...
  function MiniSlider(wrapperSelector, prev, next, activeClass, animate, autoplay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, wrapperSelector, prev, next, activeClass, animate, autoplay));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    key: "throwEnd",
    value: function throwEnd() {
      var _this2 = this;

      try {
        if (this.slides[0].tagName == "BUTTON" || this.slides[1].tagName == "BUTTON") {
          var btns = this.wrapper.querySelectorAll('[type = "button"]');
          btns.forEach(function (btn) {
            _this2.wrapper.appendChild(btn);
          });
        }
      } catch (error) {}
    }
    ...
    value: function throwToBegin() {
      ...
      try {
        if (this.slides[this.slides.length - 1].tagName == "BUTTON" || this.slides[this.slides.length - 2].tagName == "BUTTON") {
          var btns = this.wrapper.querySelectorAll('[type = "button"]');
          btns.forEach(function (btn) {
            _this3.wrapper.insertBefore(btn, _this3.slides[_this3.slides.length - 3]);
          });
        }
      } catch (error) {}
    }
      ...
      try {
        ...
        this.next.addEventListener("click", function () {
          _this4.slides.forEach(function (slide) {
            slide.classList.remove(_this4.activeClass);
            slide.querySelectorAll("div").forEach(function (d) {
              d.style.opacity = "";
            });
          });

          _this4.wrapper.appendChild(_this4.slides[0]);

          _this4.slides[0].classList.add(_this4.activeClass);

          _this4.decorateSlides();

          _this4.throwEnd();
        }); // prev

        this.prev.addEventListener("click", function () {
          var activeSlide = _this4.slides[_this4.slides.length - 1];
          ...
          _this4.wrapper.insertBefore(activeSlide, _this4.wrapper.firstChild);

          activeSlide.classList.add(_this4.activeClass);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      triggersSelector = _ref$triggersSelector === void 0 ? null : _ref$triggersSelector,
      _ref$wrapperSelector = _ref.wrapperSelector,
      wrapperSelector = _ref$wrapperSelector === void 0 ? null : _ref$wrapperSelector,
      _ref$prev = _ref.prev,
      prev = _ref$prev === void 0 ? null : _ref$prev,
      _ref$next = _ref.next,
      next = _ref$next === void 0 ? null : _ref$next,
      _ref$prevOther = _ref.prevOther,
      prevOther = _ref$prevOther === void 0 ? null : _ref$prevOther,
      _ref$nextOther = _ref.nextOther,
      nextOther = _ref$nextOther === void 0 ? null : _ref$nextOther,
...
/*#__PURE__*/
function () {
  function VideoPopup(triggerSelector, popupWrapper) {
  ...
  _createClass(VideoPopup, [{
    key: "\u0441reatePlayer",
    value: function reatePlayer(url) {
    ...
    value: function bindPlayer() {
      ...
      this.trigger.forEach(function (btn, i) {
        try {
        ...
        btn.addEventListener("click", function () {
          if (!btn.closest('.module__video-item') || btn.closest(".module__video-item").getAttribute("data-disabled") !== "true") {
            ...
            if (document.querySelector("iframe#frame")) {
              _this.popupWrapper.style.display = "flex";
            }

            _this.iframe = document.createElement("div");

            _this.iframe.setAttribute("id", "frame");

            _this.popupWrapper.firstElementChild.appendChild(_this.iframe);

            _this.сreatePlayer(btn.getAttribute("data-url"));
          }
        });
      });
    }
    ...
    value: function closePlayer() {
      ...
      this.close.addEventListener("click", function (e) {
        e.preventDefault();
        _this2.popupWrapper.style.display = "none";
